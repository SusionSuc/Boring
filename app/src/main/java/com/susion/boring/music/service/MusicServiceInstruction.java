...
public class MusicServiceInstruction {
    ...
    public static final String SERVICE_PARAM_QUEUE_ADD_SONG = "SERVICE_PARAM_QUEUE_ADD_SONG";
    public static final String SERVICE_RECEIVER_QUERY_IF_NEED_CHANGE_MUSIC = "SERVICE_RECEIVER_QUERY_IF_NEED_CHANGE_MUSIC";
    public static final String SERVICE_PARAM_QUERY_IF_NEED_CHANGE_MUSIC_SONG = "SERVICE_PARAM_QUERY_IF_NEED_CHANGE_MUSIC_SONG";
    public static final String SERVICE_PARAM_QUERY_IS_PLAYING_NEW_SONG = "SERVICE_PARAM_QUERY_IS_PLAYING_NEW_SONG";
    ...
    public static final String CLIENT_PARAM_CAN_CHANGE_MUSIC = "CLIENT_PARAM_CAN_CHANGE_MUSIC";
