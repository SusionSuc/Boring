...
public class MediaUtils {
    ...
    public static String getCurrentPreciseTime(long durationMs) {
        long minute = TimeUnit.MILLISECONDS.toMinutes(durationMs);
        long second = TimeUnit.MILLISECONDS.toSeconds(durationMs) - TimeUnit.MINUTES.toSeconds(minute);
        long millisecond = durationMs - 1000 * second;
        return String.format(Locale.getDefault(), "%02d:%02d.%03d", minute, second, millisecond);
    }
